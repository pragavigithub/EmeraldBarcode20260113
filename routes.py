...
# Note: get_warehouses route moved to api_routes.py to avoid conflicts
...
# Note: get_po_docnums route moved to api_routes.py to avoid conflicts
...
# Note: get_invt_series route moved to api_routes.py to avoid conflicts

# Note: get_invt_docentry route moved to api_routes.py to avoid conflicts
...
# Note: get_bins route moved to api_routes.py to avoid conflicts

# Note: get_batches route moved to api_routes.py to avoid conflicts

# Note: get_item_name route moved to api_routes.py to avoid conflicts
