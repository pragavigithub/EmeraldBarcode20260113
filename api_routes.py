...
def register_api_routes(app):
    ...
    @app.route('/api/get-serial-location', methods=['GET'])
    ...
    @app.route('/api/post-stock-transfer', methods=['POST'])
    def post_stock_transfer():
        """Post a stock transfer to SAP B1"""
        try:
            ...
            logging.error(f"Error in post_stock_transfer API: {str(e)}")
            return jsonify({'success': False, 'error': str(e)}), 500
